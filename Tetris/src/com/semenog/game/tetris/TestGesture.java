...
public void	train() {
    ...
    Reader learnReaderPunch = new FileReader(new File (myDir, "PunchingPonnam.seq"));
    ...
    Reader learnReaderScrolldown = new FileReader(new File (myDir, "LeftToRightPonnam.seq"));
    ...
    Reader learnReaderSend = new FileReader(new File (myDir, "RightToLeftPonnam.seq"));
